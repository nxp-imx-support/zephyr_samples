...
These are Zephyr RTOS demo projects that can run on i.MX93 MPU, namely Digital Cluster and Barcode Scanner. These demos maily shows the advantage of Zephyr RTOS on real-time performance, fast boot and light weight compaired to RT-Linux.

#### Boards: MCIMX93-EVK or MCIMX93-QSB
...
|:-------:| --------------------------------------- | --------------------------:|
| 1.0     | Initial release on Application Code HUb | April 30<sup>th</sup> 2024 |
