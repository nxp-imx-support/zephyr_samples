...
#define LV_UI_SCAN_ANIM_POS_BEGIN (120U) //(200U)
#define LV_UI_SCAN_ANIM_POS_FADE_IN (120U + 45U) //(240U)
#define LV_UI_SCAN_ANIM_POS_FADE_OUT (120U + 360U - 45U) // (560U)
#define LV_UI_SCAN_ANIM_POS_END (120U + 360U) //(600U)

#define LV_UI_SCAN_ANIM_POS_STEP (5)
#define LV_UI_SCAN_ANIM_OPA_STEP (8)
